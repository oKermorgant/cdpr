...
//* variational gains 
//************************************************************
/*#include "../cvxgen_gain/solver.h"
#include "../cvxgen_gain/solver.c"
#include "../cvxgen_gain/matrix_support.c"
#include "../cvxgen_gain/util.c"
#include "../cvxgen_gain/ldl.c"*/
//************************************************************
...
/*                // compute CoG with trianglation alogorithm
    ...
    //************************************************************************
    //* uncomment cvxgen for the slack variable algorithm and the header files 
    //************************************************************************
/*    else if ( control == cvxgen_slack)
    {
            ...
            // chose the targeted value to be the mean of tension limit
            for (int i = 0; i < 8; ++i)
                tau_star[i] = (tauMin+tauMax)/2;
