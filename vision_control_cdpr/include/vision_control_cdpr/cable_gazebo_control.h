#ifndef CABLEGAZEBOCONTROL_H
#define CABLEGAZEBOCONTROL_H
...
namespace gazebo
{
  ...
  class CableControlPlugin : public ModelPlugin
  {
  public:
    CableControlPlugin() {}
    ~CableControlPlugin()
  ...
  GZ_REGISTER_MODEL_PLUGIN(CableControlPlugin)
}
#endif // CABLEGAZEBOCONTROL_H
